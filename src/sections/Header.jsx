...
const Header = () => {
    ...
    return (
        <header className={clsx("fixed top-0 left-0 z-50 w-full py-10 transition-all duration-500 max-lg:py-4" , hasScrolled && 'py-2 bg-black-100 backdrop-blur-[8px]')}>
            <div className="container flex h-14 items-center max-leg:px-5">
                ...
                <div
                    ...
                    <div
                        ...
                        <nav className="max-lg:relative max-lg:z-2 max-lg:my-auto">
                            <ul className="flex max-lg:block max-leg:px-12">
                                <li className="nav-li">
                                ...
                                <li className="nav-logo">
                                    <LinkScroll
                                        ...
                                        spy
                                        smooth
                                        className={clsx("max-lg:hidden tranistion-transform duration-500 cursor-pointer")}
                                    >
                                        <img src="/images/xora.svg" alt="logo" width={115} height={55}/>
                                    </LinkScroll>
                                </li>
                ...
                >
                    <img src={`/images/${isOpen ? "close" : "magic"}.svg`} alt="logo"
